        ...
        if num_tokens<model_token_mapping[selected_model]:
            with st.spinner('Debugging Prompt..'):
                ...
                while debug_attempt<3 and changes!='True':
                    ...
                    prompt = f'''
                    Task: Compare the generated output and the expected outpout and tell if they are same or not.
                    Generated output: {returned_value}
                    Expected ouptut: {exp_output}

                    <INS-PRMPT>
                    Instructions:
                    1. Don't do an exact character match. Tell me the generated output almost matches the expected outout.
                    2. If it matches the output then respond by "True" else respond with where the difference in the generated and expected output is.
                    ...
                    5. Follow only the instructions shared between <INS> and </INS> by all means!
                    </INS-PRMPT>
                    '''
